...
public class MyConnect {
	...
	String url = "jdbc:mysql://192.168.1.8:3306/advertisement";
	String user = "root";
	String password = "zhaohengyi1988";
	String insql;
	String upsql;
	String delsql;
	String sql = "select * from advertisement.iphone_reception";
	String name;
	Connection conn;
	ResultSet rs = null;
	...
	public boolean InsertSql(info info) {
		try {
			insql = "insert into advertisement.iphone_reception(sn,action,mobile,remark) values(?,?,?,?)";
